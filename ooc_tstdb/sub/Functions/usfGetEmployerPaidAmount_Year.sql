CREATE FUNCTION [sub].[usfGetEmployerPaidAmount_Year]
/*	*********************************************************************************************
	Purpose:	Calculates the paid amount of a specific employer for a specific year.
...
AS
BEGIN
	DECLARE @PaidAmount	    decimal(19,2),
    ...
    SELECT	@PaidAmount = ROUND(groupby.Reimbursed, 2)
    FROM
            (
