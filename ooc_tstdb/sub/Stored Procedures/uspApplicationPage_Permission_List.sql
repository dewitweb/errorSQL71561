CREATE PROCEDURE [sub].[uspApplicationPage_Permission_List]
AS
/*	==========================================================================================
	Puspose:	Get all permissions connected to all application pages.
...
/*	== auth.uspApplicationPage_Permission_List ===============================================	*/
