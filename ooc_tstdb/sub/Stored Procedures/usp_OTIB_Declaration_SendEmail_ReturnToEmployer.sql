...
CREATE PROCEDURE [sub].[usp_OTIB_Declaration_SendEmail_ReturnToEmployer]
@DeclarationID	int,
@Reason			varchar(MAX)
AS
/*	==========================================================================================
...
SELECT @Reason = CASE WHEN @Reason <> ''	
			THEN
...
SET @EmailBody = REPLACE(@EmailBody, '<%DeclarationDate%>', ISNULL(@DeclarationDate105, ''))
...
/*	== sub.usp_OTIB_Declaration_SendEmail_ReturnToEmployer ===============================================	*/
