...
CREATE PROCEDURE [ait].[uspCreateDelUSP] 
	@SchemaName varchar(10),
	@TableName varchar(100)
AS
/*	==========================================================================================
	04-05-2016	Jaap van Assenbergh
				Genereren van een standaard delete usp
...
SELECT @OrderBy = ColumnName From @Columns WHERE Column_ID = 2
...
SET @UspName = 'usp'+ SUBSTRING(@TableName, 4, LEN(@TableName)) + '_Del'
...
SELECT	'@' + ColumnName + REPLICATE(CHAR(9), 3) + TypeName + 
...
INSERT INTO @Lines VALUES ('')
INSERT INTO @Lines VALUES ('/*	==========================================================================================')
INSERT INTO @Lines VALUES (CHAR(9) + 'Purpose: ' + CHAR(9) + 'Delete from ' + @SchemaName + '.' + @TableName + '.')
INSERT INTO @Lines VALUES ('')
...
INSERT INTO @Lines VALUES ('-- Save old record.')
INSERT INTO @Lines VALUES ('SELECT' + CHAR(9) + '@XMLdel = (' + CHAR(9) + 'SELECT ' + CHAR(9) + '*')
INSERT INTO @Lines VALUES (REPLICATE(CHAR(9), 5) + 'FROM' + CHAR(9) + @SchemaName + '.' + @TableName)
INSERT INTO @Lines VALUES (REPLICATE(CHAR(9), 5) + 'WHERE'+ CHAR(9) + @PK + ' = @' + @PK)
INSERT INTO @Lines VALUES (REPLICATE(CHAR(9), 5) + 'FOR XML PATH ),')
INSERT INTO @Lines VALUES (REPLICATE(CHAR(9), 2) + '@XMLins = NULL')
INSERT INTO @Lines VALUES ('')

INSERT INTO @Lines VALUES ('-- Delete record.')
INSERT INTO @Lines VALUES ('DELETE')
...
INSERT INTO @Lines VALUES ('IF @@ROWCOUNT > 0')
